...
async def reestr(message: types.Message):
	try:
		...
		zamena = {"а": ["а", "a", "@", "&"],"б": ["б", "6", "b"],"в": ["в", "b", "v"],"г": ["г", "r", "g"],"д": ["д", "d", "g"],"е": ["е", "e"],"ё": ["ё", "e"],"ж": ["ж", "zh", "*"],"з": ["з", "3", "z"],"и": ["и", "u", "i","n"],"й": ["й", "u", "i"],"к": ["к", "k", "i{", "|{"], "л": ["л", "l", "ji"], "м": ["м", "m"],"н": ["н", "h", "n"],"о": ["о", "o", "0", "()"],"п": ["п", "n", "p"],"р": ["р", "r", "p"],"с": ["с", "c", "s"],"т": ["т", "m", "t"],"у": ["у", "y", "u"],"ф": ["ф", "f"],"х": ["х", "x", "h", "}{"],"ц": ["ц", "c", "u,"],"ч": ["ч", "ch"],"ш": ["ш", "sh"],"щ": ["щ", "sch"],"ь": ["ь", "b"],"ы": ["ы", "bi", "bI", "bl"],"ъ": ["ъ", "b"],"э": ["э", "е", "e"],"ю": ["ю", "io", "Io", "lo"],"я": ["я", "ya", "y", "a", "&"]}
